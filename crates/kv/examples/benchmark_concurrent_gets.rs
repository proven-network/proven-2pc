...
fn main() {
    ...
    for thread_id in 0..NUM_READERS {
        ...
        let handle = thread::spawn(move || {
            ...
            (thread_id, successful_reads, blocked_reads, duration)
        });
    ...
    let total_reads = total_successful + total_blocked;
    ...
    println!("Blocked reads:         {}", total_blocked);
    println!("\nTiming:");
    println!(

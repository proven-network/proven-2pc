...
fn test_glue_objects_system_view() {
    // TODO: Test SELECT OBJECT_NAME, OBJECT_TYPE FROM GLUE_OBJECTS
...
fn test_glue_objects_table_and_index_types() {
    // TODO: Test that GLUE_OBJECTS correctly distinguishes between TABLE and INDEX object types
}

#[ignore = "not yet implemented"]
#[test]
fn test_glue_objects_shows_all_created_objects() {
    // TODO: Test that GLUE_OBJECTS includes both the table and all indexes created on it
}

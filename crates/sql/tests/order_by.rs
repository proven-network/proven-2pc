...
fn test_order_by_with_where_clause() {
    ...
    assert_eq!(results[0].get("value").unwrap(), "I32(50)");
    assert_eq!(results[1].get("value").unwrap(), "I32(40)");
    assert_eq!(results[2].get("value").unwrap(), "I32(20)");
    assert_eq!(results[3].get("value").unwrap(), "I32(10)");
...
fn test_order_by_with_expressions() {
    ...
    assert_eq!(results.len(), 5);
    assert_eq!(results[0].get("sum").unwrap(), "I32(32)"); // 30 + 2
    assert_eq!(results[1].get("sum").unwrap(), "I32(28)"); // 20 + 8
    assert_eq!(results[2].get("sum").unwrap(), "I32(25)"); // 15 + 10
    assert_eq!(results[3].get("sum").unwrap(), "I32(20)"); // 5 + 15
    assert_eq!(results[4].get("sum").unwrap(), "I32(15)"); // 10 + 5
...
fn test_order_by_boolean_column() {
    ...
    assert_eq!(results.len(), 5);
    assert_eq!(results[0].get("active").unwrap(), "Bool(false)");
    assert_eq!(results[1].get("active").unwrap(), "Bool(false)");
    assert_eq!(results[2].get("active").unwrap(), "Bool(true)");
    assert_eq!(results[3].get("active").unwrap(), "Bool(true)");
    assert_eq!(results[4].get("active").unwrap(), "Bool(true)");
...
fn test_order_by_float_column() {
    ...
    assert_eq!(results.len(), 5);
    assert_eq!(results[0].get("id").unwrap(), "I32(1)"); // 95.5
    assert_eq!(results[1].get("id").unwrap(), "I32(3)"); // 92.8
    assert_eq!(results[2].get("id").unwrap(), "I32(5)"); // 90.0
    assert_eq!(results[3].get("id").unwrap(), "I32(4)"); // 88.1
    assert_eq!(results[4].get("id").unwrap(), "I32(2)"); // 87.3
...
fn test_order_by_with_limit() {
    ...
    assert_eq!(results.len(), 3);
    assert_eq!(results[0].get("value").unwrap(), "I32(70)");
    assert_eq!(results[1].get("value").unwrap(), "I32(60)");
...
fn test_order_by_with_duplicate_values() {
    ...
    assert_eq!(results[1].get("value").unwrap(), "I32(100)");
    assert_eq!(results[2].get("value").unwrap(), "I32(100)");

    // Then value=200 rows
    assert_eq!(results[3].get("value").unwrap(), "I32(200)");
    assert_eq!(results[4].get("value").unwrap(), "I32(200)");
...
fn test_order_by_case_expression() {
    ...
    assert_eq!(results.len(), 5);
    assert_eq!(results[0].get("status").unwrap(), "Str(\"failed\")");
    assert_eq!(results[1].get("status").unwrap(), "Str(\"pending\")");
    assert_eq!(results[2].get("status").unwrap(), "Str(\"pending\")");

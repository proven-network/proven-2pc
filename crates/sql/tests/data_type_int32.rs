...
fn setup_int32_table(ctx: &mut common::TestContext) {
...
fn test_int32_basic_select() {
    ...
    assert_eq!(results[0].get("field_one").unwrap(), "I32(-4)");
    assert_eq!(results[0].get("field_two").unwrap(), "I32(-4)");

    assert_eq!(results[1].get("field_one").unwrap(), "I32(-2)");
    assert_eq!(results[1].get("field_two").unwrap(), "I32(2)");

    assert_eq!(results[2].get("field_one").unwrap(), "I32(1)");
    assert_eq!(results[2].get("field_two").unwrap(), "I32(-1)");

    assert_eq!(results[3].get("field_one").unwrap(), "I32(3)");
    assert_eq!(results[3].get("field_two").unwrap(), "I32(3)");
...
fn test_int32_where_greater_than() {
    ...
    assert_eq!(results[0].get("field_one").unwrap(), "I32(1)");
    assert_eq!(results[1].get("field_one").unwrap(), "I32(3)");
...
fn test_int32_arithmetic_addition() {
    ...
    assert_eq!(results[0].get("plus").unwrap(), "I32(-8)");
    assert_eq!(results[1].get("plus").unwrap(), "I32(0)");
    assert_eq!(results[2].get("plus").unwrap(), "I32(0)");
    assert_eq!(results[3].get("plus").unwrap(), "I32(6)");
...
fn test_int32_arithmetic_subtraction() {
    ...
    assert_eq!(results[0].get("sub").unwrap(), "I32(0)");
    assert_eq!(results[1].get("sub").unwrap(), "I32(-4)");
    assert_eq!(results[2].get("sub").unwrap(), "I32(2)");
    assert_eq!(results[3].get("sub").unwrap(), "I32(0)");
...
fn test_int32_arithmetic_multiplication() {
    ...
    assert_eq!(results[0].get("mul").unwrap(), "I32(16)");
    assert_eq!(results[1].get("mul").unwrap(), "I32(-4)");
    assert_eq!(results[2].get("mul").unwrap(), "I32(-1)");
    assert_eq!(results[3].get("mul").unwrap(), "I32(9)");
...
fn test_int32_arithmetic_division() {
    ...
    assert_eq!(results[0].get("div").unwrap(), "I32(1)");
    assert_eq!(results[1].get("div").unwrap(), "I32(-1)");
    assert_eq!(results[2].get("div").unwrap(), "I32(-1)");
    assert_eq!(results[3].get("div").unwrap(), "I32(1)");
...
fn test_int32_arithmetic_modulo() {
    ...
    assert_eq!(results[0].get("modulo").unwrap(), "I32(0)");
    assert_eq!(results[1].get("modulo").unwrap(), "I32(0)");
    assert_eq!(results[2].get("modulo").unwrap(), "I32(0)");
    assert_eq!(results[3].get("modulo").unwrap(), "I32(0)");

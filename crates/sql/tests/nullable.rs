...
fn test_nullable_column_basic_operations() {
    ...
    assert_eq!(results[1].get("num").unwrap(), "I32(4)");
    assert_eq!(results[1].get("name").unwrap(), "Str(Great)");

    assert_eq!(results[2].get("id").unwrap(), "I32(1)");
    assert_eq!(results[2].get("num").unwrap(), "I32(9)");
    assert_eq!(results[2].get("name").unwrap(), "Str(World)");
...
fn test_is_not_null_condition() {
    ...
    assert_eq!(results[0].get("num").unwrap(), "I32(9)");
    assert_eq!(results[1].get("id").unwrap(), "I32(3)");
    assert_eq!(results[1].get("num").unwrap(), "I32(4)");
...
fn test_select_null_arithmetic_results() {
    ...
    assert_eq!(results.len(), 1);
    assert_eq!(results[0].get("add1").unwrap(), "Null");
    assert_eq!(results[0].get("add2").unwrap(), "Null");
    assert_eq!(results[0].get("sub1").unwrap(), "Null");
    assert_eq!(results[0].get("sub2").unwrap(), "Null");
    assert_eq!(results[0].get("mul1").unwrap(), "Null");
    assert_eq!(results[0].get("mul2").unwrap(), "Null");
    assert_eq!(results[0].get("div1").unwrap(), "Null");
    assert_eq!(results[0].get("div2").unwrap(), "Null");
...
fn test_update_null_values() {
    ...
    assert_eq!(results[2].get("id").unwrap(), "I32(2)");
...
fn test_nullable_text_column() {
    ...
    assert_eq!(results[0].get("name").unwrap(), "Str(Hello)");
    assert_eq!(results[1].get("id").unwrap(), "I32(2)");
    assert_eq!(results[1].get("name").unwrap(), "Null");

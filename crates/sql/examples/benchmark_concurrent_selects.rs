...
fn main() {
    ...
    for thread_id in 0..NUM_READERS {
        ...
        let handle = thread::spawn(move || {
            ...
            (thread_id, successful_queries, blocked_queries, duration)
        });
    ...
    for handle in handles {
        let (thread_id, successful, blocked, duration) = handle.join().unwrap();
    ...
    let total_queries = total_successful + total_blocked;
    ...
    println!("Blocked queries:       {}", total_blocked);
    println!("\nTiming:");
    println!(
